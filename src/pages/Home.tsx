        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-8 w-full">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-6 max-w-4xl">
              <h1 className="title-hero text-on-surface w-full leading-tight">
                HACEMOS <br />
                <span className="[box-decoration-break:clone] pl-0 pr-4 -mr-4 text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-tertiary italic">
                  QUE LA VOZ SUENE.
                </span>
              </h1>
            </div>
